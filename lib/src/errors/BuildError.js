...
var BuildError = (function (_super) {
    ...
    function BuildError() {
        ...
        _super.call(this, ErrorCategory_1.ErrorCategory.BuildError, args.length > 2 ? args[0] : null, args.length > 2 ? args[1] : args.length > 1 ? args[0] : null, args.length > 2 ? args[2] : args.length > 1 ? args[1] : args[0]);
        this.withStatus(500);
    }
    return BuildError;
